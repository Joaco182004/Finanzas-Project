...
public class FinancialRun {
    ...
    public FinancialRun(String typeMoney, Double priceProperty, Double firstFee, Double amountFinance, String nameRate, String timeRate, Double rate, String frequencyPay, Double convertRate,String nameConvertRate, Double numberYear, Double numberPeriods, String gracePeriod, Double numberGracePeriod,Customer customer) {
